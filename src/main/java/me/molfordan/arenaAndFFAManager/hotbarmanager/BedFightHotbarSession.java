...
import me.molfordan.arenaAndFFAManager.manager.BedFightHotbarDataManager;
...
public class BedFightHotbarSession {
    ...
    public BedFightHotbarSession(ArenaAndFFAManager plugin, Player player, BedFightHotbarDataManager dataManager, KitManager kitManager) {
        this.plugin = plugin;
        this.player = player;
