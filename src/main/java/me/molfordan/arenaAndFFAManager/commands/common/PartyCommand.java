...
public class PartyCommand implements CommandExecutor {
    ...
    public PartyCommand(ArenaAndFFAManager plugin) {
        this.plugin = plugin;
        ...
        switch (sub) {
            ...
            case "acceptchallenge":
                ...
                if (challenger != null && partyManager.hasChallenge(challenger.getUniqueId(), player.getUniqueId())) {
                    ...
                    me.molfordan.arenaAndFFAManager.object.Arena arena = null;
                    java.util.List<me.molfordan.arenaAndFFAManager.object.Arena> arenas = new java.util.ArrayList<>(plugin.getBedFightArenaManager().getArenas());
                    if (!arenas.isEmpty()) {
