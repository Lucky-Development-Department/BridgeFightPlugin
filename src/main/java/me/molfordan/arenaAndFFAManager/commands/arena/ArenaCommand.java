package me.molfordan.arenaAndFFAManager.commands.arena;
...
public class ArenaCommand implements CommandExecutor {
    ...
    public ArenaCommand(ArenaManager manager, ConfigManager configManager, ArenaAndFFAManager plugin) {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        switch (sub) {
            ...
            case "restore":
                int restoredCount = 0;
                String worldName = plugin.getConfigManager().getBuildFFAWorldName();
                World world = Bukkit.getWorld(worldName);
