...
import me.molfordan.bridgefightplugin.listener.LadderRestorer;
...
public class ArenaManager {
    ...
    public ArenaManager(File dataFolder, BridgeFightPlugin plugin, LadderRestorer ladderRestorer) {
