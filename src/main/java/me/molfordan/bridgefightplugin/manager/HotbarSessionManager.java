...
import me.molfordan.bridgefightplugin.hotbarmanager.HotbarSession;
...
public class HotbarSessionManager {
    ...
    public HotbarSessionManager(BridgeFightPlugin plugin, HotbarDataManager dataManager, KitManager kitManager) {
        this.plugin = plugin;
