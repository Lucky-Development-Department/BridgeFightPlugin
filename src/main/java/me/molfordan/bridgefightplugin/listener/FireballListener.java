...
import me.molfordan.bridgefightplugin.manager.FireballTracker;
import me.molfordan.bridgefightplugin.utils.FireballUtil;
...
public class FireballListener implements Listener {
    ...
    public void onFireballInteract(PlayerInteractEvent e) {
        ...
        }.runTaskTimer(BridgeFightPlugin.getPlugin(), 1L, 1L);
