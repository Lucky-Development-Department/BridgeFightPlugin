...
import me.molfordan.bridgefightplugin.placeholder.LeaderboardPlaceholderExpansion.LBEntry;
import me.molfordan.bridgefightplugin.utils.HeadUtils;
...
public class GUILeaderboardBuildFFA {

    private final BridgeFightPlugin plugin;

    public GUILeaderboardBuildFFA(BridgeFightPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public void open(Player p, String metric, int page, List<LBEntry> entries) {
        ...
        Inventory inv = Bukkit.createInventory(null, 54,
                "§8BuildFFA §7- §e" + metric + " §7(Page " + page + ")");
