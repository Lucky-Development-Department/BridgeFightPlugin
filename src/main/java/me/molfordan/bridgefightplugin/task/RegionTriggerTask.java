...
import me.molfordan.bridgefightplugin.region.CommandRegion;
...
public class RegionTriggerTask extends BukkitRunnable {
    ...
    public void sendToServer(Player player, String server) {
        ...
        player.sendPluginMessage(BridgeFightPlugin.getPlugin(), "nebula:main", b.toByteArray());
        player.sendPluginMessage(BridgeFightPlugin.getPlugin(), "BungeeCord", b.toByteArray());
    }
}
