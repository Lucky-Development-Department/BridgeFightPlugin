...
import me.molfordan.bridgefightplugin.manager.BridgeFightBanManager;
import me.molfordan.bridgefightplugin.utils.DurationParser;
...
public class BridgeBanCommand implements CommandExecutor {
    ...
    public BridgeBanCommand(BridgeFightBanManager banManager, BridgeFightPlugin plugin) {
