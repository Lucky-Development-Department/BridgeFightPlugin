...
import me.molfordan.bridgefightplugin.manager.ReportManager;
import me.molfordan.bridgefightplugin.manager.ReportManager.ReportData;
...
public class ReportsCommand implements CommandExecutor {
    ...
    public ReportsCommand(BridgeFightPlugin plugin) {
        this.plugin = plugin;
    }
